...
class _WeatherApi implements WeatherApi {
  ...
  Future<Fetch36HoursWeatherResponseDto> fetch36HoursWeather(
      Fetch36HoursWeatherRequestDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(body.toJson());
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<Fetch36HoursWeatherResponseDto>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late Fetch36HoursWeatherResponseDto _value;
    try {
      _value = Fetch36HoursWeatherResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
