...
mixin _$Credential {
  ...
  String get emailAccount => throw _privateConstructorUsedError;
...
abstract class $CredentialCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String userName, String emailAccount});
}
    ...
    return _then(_value.copyWith(
      ...
      userName: null == userName
          ...
          : userName // ignore: cast_nullable_to_non_nullable
              as String,
      emailAccount: null == emailAccount
          ? _value.emailAccount
...
class _$CredentialImpl implements _Credential {
  _$CredentialImpl(
      {required this.uid, required this.userName, required this.emailAccount});
  ...
  @override
  String toString() {
    return 'Credential(uid: $uid, userName: $userName, emailAccount: $emailAccount)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, uid, userName, emailAccount);
...
abstract class _Credential implements Credential {
  factory _Credential(
      ...
      required final String emailAccount}) = _$CredentialImpl;
